...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        print("self.weights_input_to_hidden UPDATED: ", self.weights_input_to_hidden)
        print("self.weights_hidden_to_output UPDATED: ", self.weights_hidden_to_output)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_h_o += np.array([(output_error_term * hidden_outputs)]).T

        print("delta_weights_i_h UPDATED: ", delta_weights_i_h)
        print("delta_weights_h_o UPDATED: ", delta_weights_h_o)
